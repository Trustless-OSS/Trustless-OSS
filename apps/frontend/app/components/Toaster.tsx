    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          description:
            'group-[.toast]:text-slate-600 group-[.toast]:font-sans group-[.toast]:font-bold group-[.toast]:text-xs group-[.toast]:uppercase',
          actionButton:
          ...
          error:
            'group-[.toaster]:border-red-600 group-[.toaster]:shadow-[8px_8px_0px_0px_#ef4444]',
          success:
            'group-[.toaster]:border-emerald-600 group-[.toaster]:shadow-[8px_8px_0px_0px_#10b981]',
        },
      }}
      {...props}
    />
