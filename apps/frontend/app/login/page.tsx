    ...
    <div className="min-h-[calc(100vh-24px)] flex items-center justify-center p-6 selection:bg-blue-600 selection:text-white">
      <div className="w-full max-w-md">
        <div className="bg-white brutal-border p-8 md:p-12 brutal-shadow relative">
          ...
          <h1 className="title-brutal text-4xl mb-4 text-slate-950">AUTHENTICATE</h1>

          <p className="text-slate-600 font-mono text-sm mb-10 font-medium">
            &gt; Initialize session via GitHub OAuth.
            <br />
          ...
          <button
            onClick={handleLogin}
            disabled={loading}
            className="brutal-button w-full py-4 text-lg flex items-center justify-center gap-4 disabled:opacity-50"
          >
            {loading ? (
              <>
